  ...
  return (
    <section id="how-it-works" className="py-16 md:py-24 bg-white border-b border-zinc-100">
      <div className="max-w-[1380px] mx-auto px-4 sm:px-8 lg:px-[65px]">
        {/* Header - 2 Columns (Stacked on mobile, side-by-side on desktop) */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 items-start mb-12 sm:mb-16 md:mb-20 text-left">
